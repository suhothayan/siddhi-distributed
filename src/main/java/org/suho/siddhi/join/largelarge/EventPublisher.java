...
package org.suho.siddhi.join.largelarge;
...
public class EventPublisher {
    public static void main(String[] args) throws InterruptedException {
        ...
        String siddhiApp = "" +
                "@app:name('publisher')\n" +
                "\n" +
                "@sink(type='tcp', url='tcp://127.0.0.1:9892/join/StreamA', sync='true', @map(type='binary')) \n" +
                "define stream StreamA (symbol string, price float, volume long);\n" +
                "\n" +
                "@sink(type='tcp', url='tcp://127.0.0.1:9892/join/StreamB', sync='true', @map(type='binary')) \n" +
